...
print(f"my fav book is {fav_book()}")
#fav_book(str)
...
print(f"dimensione della maglia: {make_shirt()} messaggio sulla maglia {massage()}")
...
print(f"dimensione della maglia: {make_shirt()} messaggio sulla maglia {massage()}")
print(f"dimensione della maglia: {make_shirt2()} messaggio sulla maglia {massage2()}")
print(f"dimensione della maglia: {make_shirt3()} messaggio sulla maglia {massage3()}")
...
def describe_city(city: str, country: str = "italia") -> str:
    return city, country
...
def describe_city(city: str, country: str = "inghilterra") -> str:
    return city, country
print(describe_city('londra'))

def describe_city2(city: str, country: str = "italia") -> str:
    return city, country
print(describe_city2('roma'))

def describe_city3(city: str, country: str = "spagna") -> str:
    return city, country
print(describe_city3('barcellona'))
...
message = ("bello", "scemo", "pescepalla")
...
messages2: list = send_messages(message)
...
send_message3: list = send_messages(messages2)
print(f"{messages2}\n{message}")
print(message)
...
def build_profile(first_name: str, last_names: str, chiave: dict) -> str:
    message = f"{first_name} {last_names}"
    if chiave:
        for item in chiave.items():
            message += f" {item[0]} {item[1]},"

    return message[:-1]

info = {'age': 19, 'weight': 70}
print(f"{build_profile('angelo',  'locarini', info)}")
...
print(f"{make_car('subaruclear','outback',color='blue',tow_package=True)}\n")
