...
restaurant1: Restaurant = Restaurant("Ristorante", "italiano")
...
restaurant2: Restaurant = Restaurant("Ginza","Giapponese")
restaurant3: Restaurant = Restaurant("La Catena","Italiano")
restaurant4: Restaurant = Restaurant("Mc Donald","Americano")
...
user1: User = User("Angelo","Locarini","angelolocarini@gmail.com","AngeloLocarini")
user2: User = User("Gabriele","DeCupis","decupis@gmail.com")
user3: User = User("Will","Smith","will@outlook.it")
...
restaurant5: Restaurant = Restaurant("La catena","italiano")
